...
#' \code{\link{lcmm::multlcmm}} that makes it much easier to
#' estimate of several MLPMMs. In general, ensuring 
...
#' directly with \code{\link{lcmm::multlcmm}}, trying to manually solve
